 ...
 * 
 */
public class CopyOfMainLoop extends JFrame {
...
//		content = new Vector<>();
	...
	private void tableRightClicked(MouseEvent e) {
		if (e.isMetaDown()) {
			...
			for (int i = 0; i < 4; i++) {
				...
				try {
					Class<CopyOfMainLoop> mainLoopClass = CopyOfMainLoop.class;
	...
	public static void main(String[] args) {
		CopyOfMainLoop mLoop = new CopyOfMainLoop();
